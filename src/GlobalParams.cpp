...
int GlobalParams::traffic_single_packet_src_id;
string GlobalParams::traffic_single_packet_src_chip;
int GlobalParams::traffic_single_packet_dst_id;
string GlobalParams::traffic_single_packet_dst_chip;
...
map<string, MeshComponentConfig> GlobalParams::mesh_component_config;
bool GlobalParams::route_using_selection_strategy;
bool GlobalParams::enable_vc_reallocation;
