...
class Buffer {
    using const_iterator = deque<Flit>::const_iterator;
  public:
    ...
    void UpdateFront(const Flit & flit);	// Update front flit. If empty, push the new flit in the buffer
    ...
    void atomicFlowControlCheck() const;
